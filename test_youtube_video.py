...
from modules.youtube_video_downloader import YouTubeVideoDownloader
from modules.downloader_base import DownloadSettings


def test_youtube_video():
    """Тест скачивания YouTube Video"""
    
    print("=" * 70)
    print("🧪 ТЕСТ: YouTube Video Downloader")
    print("=" * 70)
    print()
    ...
    test_urls = [
        ...
        ("https://www.youtube.com/shorts/dQw4w9WgXcQ", False),  # Shorts
    ...
    # Запрос URL
    print("📝 Введите YouTube Video URL для теста:")
    print("   Пример: https://youtu.be/K-entGTyNq4")
    ...
    if not downloader.can_handle(url):
        ...
        print("   Это должен быть YouTube Video URL (не /shorts/)")
        return
    ...
    try:
        ...
        if result.transcript_file:
            print(f"📝 Субтитры: {result.transcript_file}")
